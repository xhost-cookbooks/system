...
|           |    Travis CI    |
|-----------|-----------------|
| **Master** |[![Build status](https://secure.travis-ci.org/xhost-cookbooks/system.png?branch=master)|
| **Latest Release (0.6.4)** |[![Build status]https://api.travis-ci.org/xhost-cookbooks/system.png?branch=v0.6.4)|
